...
class WhisperModel:
    def __init__(
        ...
        # /Users/hugo/.cache/huggingface/hub/models--models--medium.en/refs/main
        ...
        # else:
        #     self.hf_tokenizer = Tokenizer.from_pretrained(
